static	char	RCSid[] =
"$Header: undo.c,v 1.4 88/08/26 08:45:56 tony Exp $";
 ...
 *
 * $Log:	undo.c,v $
 * Revision 1.4  88/08/26  08:45:56  tony
 * Misc. changes to make lint happy.
 * 
 * Revision 1.3  88/08/17  07:38:14  tony
 * Made u_save() more robust by checking for null parameters. It's up to
 * the caller to notice the problem before it causes trouble elsewhere.
 * 
 * Revision 1.2  88/07/09  20:39:11  tony
 * Added routines to implement the 'U' command.
 * 
 * Revision 1.1  88/03/20  21:10:53  tony
 * Initial revision
 * 
 */
