static	char	RCSid[] =
"$Header: screen.c,v 1.4 88/08/26 08:45:43 tony Exp $";

/*
 * Routines to manipulate the screen representations.
 *
 * $Log:	screen.c,v $
 * Revision 1.4  88/08/26  08:45:43  tony
 * Misc. changes to make lint happy.
 * 
 * Revision 1.3  88/06/26  14:50:59  tony
 * Added a new routine prt_line() to just dump a line of text, handling
 * control characters, etc. appropriately.
 * 
 * Revision 1.2  88/05/01  20:09:39  tony
 * Added support for  the new "number" parameter.
 * 
 * Revision 1.1  88/03/20  21:10:21  tony
 * Initial revision
 * 
 *
 */
