...
#define IDLIN	1	/* Has I/D line */
#define IDCHR	2	/* Has I/D char */
/*#define INSMODE 4	*//* Has insert-char mode */
#define CLEOL	010	/* Has clear-to-eol */
#define METAKEY	020	/* Has meta key */
#define DIRVID	040	/* Has direct-video type interface */
#define TC_SO	0100	/* Has usable standout mode */
