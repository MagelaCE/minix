...
#define MINIX	0	/* Running on MINIX (IBM-PC) system */
...
#if SUN	/* Sun window global declarations */
int sun_winfd;		/* If non-zero, contains file descriptor of window */
int sun_rdevf;		/* If non-z, permit mouse event on next TTY input */
#define FNAMELEN 255	/* Max size of last filename component */
#define FNAMSIZ 400	/* Max size of complete filename */
#define TX_SUNCON 1	/* Ensure SUN console included in support */
#endif /*SUN*/
...
#endif
#ifndef TX_SUNCON
#define TX_SUNCON 0	/* "SUN"	- Sun Microsystems console */
#endif
#ifndef TX_COHIBM
