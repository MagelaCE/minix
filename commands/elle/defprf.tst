...
(keybind ^Y "Un-kill")
(keybind ^Z "Error Throw")
(keybind ^[ "Prefix Meta")
(keybind "^\" "Debug Mode")
(keybind ^^ "Hit Breakpoint")
(keybind ^_ "Describe")
(keybind " " "Insert Self")
(keybind ! "Insert Self")
(keybind """" "Insert Self")
...
(keybind M-I "Indent Under")
(keybind M-M "Back to Indentation")
(keybind M-O "VT100 button hack")
...
(keybind X-^Z "Return to Superior")
(keybind X-^C "Return to Superior")
(keybind X-2 "Two Windows")
(keybind X-1 "One Window")
(keybind X-O "Other Window")
(keybind X-^ "Grow Window")
(keybind X-G "Grow Window")
(keybind X-! "Push to Inferior")
(keybind X-K "Kill Buffer")
(keybind X-% "Replace String")
(keybind "X-(" "Start Kbd Macro")
(keybind "X-)" "End Kbd Macro")
(keybind X-E "Execute Kbd Macro")
(keybind X-* "View Kbd Macro")		; Maybe omething else?
(keybind X-. "Set Fill Prefix")
(keybind X-T "Auto Fill Mode")		; Temporary for now
(keybind X-^M "EOL Mode Toggle")

(keybind M-P "Scroll Window Up")
